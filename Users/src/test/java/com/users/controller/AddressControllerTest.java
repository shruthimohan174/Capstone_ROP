...
public class AddressControllerTest {
  ...
  void updateAddressTests() throws Exception {
    when(addressService.updateAddress(eq(1), any(AddressRequest.class))).thenReturn(addressResponse);
  ...
  void getAllAddressesTests() throws Exception {
    when(addressService.getAllAddress()).thenReturn(Collections.singletonList(address));
  ...
  void findAddressesByUserIdTests() throws Exception {
    when(addressService.getAddressByUserId(1)).thenReturn(Collections.singletonList(address));
